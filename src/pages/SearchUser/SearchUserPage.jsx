...
const SearchUserPage = () => {
  ...
  useEffect(() => {
    const handler = setTimeout(debouncedSearch, 400); // reduced debounce for faster UX
  ...
  return (
    <div className="search-user-page" style={{ position: "relative" }}>
      ...
      <div className="search-bar">
        ...
        {/* 🔹 Clear Button */}
        {squery && (
          <button className="clear-btn" onClick={clearSearchHandler}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24px"
              height="24px"
      ...
      {/* User grid */}
      <div className="user-grid">{memoizedResults}</div>
    </div>
  );
};
